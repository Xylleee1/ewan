            ...
            <div id="notification-list" style="max-height: 300px; overflow-y: auto;">
                ...
                <?php else:
                    foreach ($notifications as $notification): ?>
                        <li class="notification-item <?= $notification['is_read'] ? '' : 'unread' ?>" data-id="<?= $notification['notification_id'] ?>" data-related-id="<?= $notification['related_id'] ?? '' ?>" data-related-type="<?= $notification['related_type'] ?? '' ?>">
                            <a class="dropdown-item notification-link" href="#" onclick="handleHeaderNotificationClick(<?= $notification['notification_id'] ?>, '<?= $notification['related_id'] ?? '' ?>', '<?= $notification['related_type'] ?? '' ?>')">
                                <div class="d-flex">
